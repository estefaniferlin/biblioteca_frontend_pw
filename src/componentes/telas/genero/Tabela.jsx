...
function Tabela() {
    const { setObjeto, alerta, setAlerta, listaObjetos, remover,
        setEditar, recuperar } = useContext(GeneroContext);

    return (
        <div style={{ padding: '20px' }}>
            <h1>Gêneros</h1>
            <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalEdicao" title="Criar gênero"
                onClick={() => {
